...
Partial Class admin_viewAllMaterials
    ...
    Protected Sub Button_search_Click(sender As Object, e As System.EventArgs) Handles Button_search.Click
        ...
        searchword = "Select * From PL_Materials where (Title Like '%" + MaterialSearchTextBox.Text.ToString() + "%') OR (Author Like '%" + MaterialSearchTextBox.Text.ToString() + "%') OR (Description Like '%" + MaterialSearchTextBox.Text.ToString() + "%')"
